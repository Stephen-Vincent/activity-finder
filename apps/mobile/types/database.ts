...
export type Database = {
  ...
  public: {
    Tables: {
      bookings_clicks: {
        Row: {
          ...
          id: string
          provider: Database["public"]["Enums"]["booking_provider"]
          user_id: string | null
          venue_id: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "bookings_clicks_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "bookings_clicks_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "bookings_clicks_venue_id_fkey"
            columns: ["venue_id"]
            isOneToOne: false
      ...
      events: {
        Row: {
          booking_provider:
            | Database["public"]["Enums"]["booking_provider"]
            | null
      ...
      favourites: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "favourites_venue_id_fkey"
            columns: ["venue_id"]
            isOneToOne: false
            referencedRelation: "venues"
            referencedColumns: ["id"]
      ...
      school_terms: {
        Row: {
          ...
          id: string
          is_holiday: boolean
          region: Database["public"]["Enums"]["school_region"]
          starts_on: string
          term_name: string
        }
        Insert: {
      ...
      venue_owners: {
        Row: {
          created_at: string
          role: Database["public"]["Enums"]["venue_owner_role"]
          user_id: string
          venue_id: string
      ...
      venues: {
        Row: {
          ...
          tier: Database["public"]["Enums"]["venue_tier"]
          town: string | null
          updated_at: string
          verified_at: string | null
          website: string | null
    ...
    Functions: {
      ...
      claim_venue: {
        Args: { p_evidence?: Json; p_venue_id: string }
        Returns: string
      }
